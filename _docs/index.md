...
- [CLI Documentation](https://github.com/dreego-stack/dreego/blob/main/_docs/cli-index.md) — CLI, generation, and language tooling
- [SSR Adapter Documentation](https://github.com/dreego-stack/dreego/blob/main/_docs/ssr-index.md) — HTTP hosting, middleware, sessions
- [Wails Adapter Documentation](https://github.com/dreego-stack/dreego/blob/main/_docs/wails-index.md) — listener-free desktop render adapter
- [dreegotest Documentation](https://github.com/dreego-stack/dreego/blob/main/_docs/dreegotest-index.md) — public test helpers
...
- [Wails v3](https://github.com/dreego-stack/dreego/blob/main/_docs/phase-1.md) — Experimental desktop adapter, capability boundary, and toolchain
