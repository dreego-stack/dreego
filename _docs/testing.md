...
| no-layout | ⬜ pos | Page without layout file |
...
| nested-component | ⬜ pos | Component calls another component |
| empty-props | ⬜ pos | Component without props |
| multi-props | ⬜ pos | Component with 3+ props |
| prop-default | ⬜ pos | Prop with default value |
| prop-expression | ⬜ pos | Prop value from expression: `title={user.Name}` |
