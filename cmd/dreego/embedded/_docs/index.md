...
- [Layouts](https://codeberg.org/dreego/dreego/src/branch/main/_docs/layouts.md) — `{#slot}` / `{#head}` and route head behavior
...
- [Session Encryption](https://codeberg.org/dreego/dreego/src/branch/main/_docs/session-encryption.md) — AES-256-GCM encrypted session cookies
...
- [Deployment](https://codeberg.org/dreego/dreego/src/branch/main/_docs/deployment.md) — Build, Cross-Compile, Containers
