# v0.3 semantic sections and language processors

## Goal

Adopt purpose-based root sections and establish a safe, versioned extension
boundary for optional source languages. Dreego continues to own document
structure, component composition, template control flow, escaping, diagnostics,
and generated Go integration.

## Section migration

The breaking migration is:
